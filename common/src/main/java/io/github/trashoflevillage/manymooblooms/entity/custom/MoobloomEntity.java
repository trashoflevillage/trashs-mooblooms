...
public class MoobloomEntity extends CowEntity implements Shearable {
    ...
    private HashMap<TagKey<Item>, HashMap<String, Item>> getDyeableItemHashmap() {
        ...
        dyedItems.put(ConventionalTags.Items.CONCRETE_POWDERS, new HashMap<>());
        entry = dyedItems.get(ConventionalTags.Items.CONCRETE_POWDERS);
        ...
        dyedItems.put(ConventionalTags.Items.CONCRETE, new HashMap<>());
        entry = dyedItems.get(ConventionalTags.Items.CONCRETE);
        ...
        dyedItems.put(ConventionalTags.Items.GLASS_BLOCKS, new HashMap<>());
        entry = dyedItems.get(ConventionalTags.Items.GLASS_BLOCKS);
        ...
        dyedItems.put(ConventionalTags.Items.GLASS_PANES, new HashMap<>());
        entry = dyedItems.get(ConventionalTags.Items.GLASS_PANES);
        ...
        dyedItems.put(ConventionalTags.Items.SHULKER_BOXES, new HashMap<>());
        entry = dyedItems.get(ConventionalTags.Items.SHULKER_BOXES);
        ...
        dyedItems.put(ConventionalTags.Items.GLAZED_TERRACOTTAS, new HashMap<>());
        entry = dyedItems.get(ConventionalTags.Items.GLAZED_TERRACOTTAS);
