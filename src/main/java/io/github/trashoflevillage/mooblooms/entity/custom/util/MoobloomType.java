...
public class MoobloomType {
    ...
    public static final MoobloomType LIGHT_GRAY =
            register(Identifier.of(ManyMooblooms.MOD_ID, "light_gray"), new MoobloomType(ModBlocks.BELLFLOWER.getDefaultState(), Items.LIGHT_GRAY_DYE)).setFlowerScale(0.5f);
    ...
    public static final MoobloomType BLACK =
            register(Identifier.of(ManyMooblooms.MOD_ID, "black"), new MoobloomType(ModBlocks.WITHERED_BUTTERCUP.getDefaultState(), Items.BLACK_DYE)).setFlowerScale(1f);
    ...
    public static final MoobloomType YELLOW =
            register(Identifier.of(ManyMooblooms.MOD_ID, "yellow"), new MoobloomType(ModBlocks.BUTTERCUP.getDefaultState(), Items.YELLOW_DYE)).setFlowerScale(1f);
    ...
    public static final MoobloomType GREEN =
            register(Identifier.of(ManyMooblooms.MOD_ID, "green"), new MoobloomType(ModBlocks.GLADIOLI.getDefaultState(), Items.GREEN_DYE)).setFlowerScale(1f);
    ...
    public static final MoobloomType PINK =
            register(Identifier.of(ManyMooblooms.MOD_ID, "pink"), new MoobloomType(ModBlocks.HIBISCUS.getDefaultState(), Items.PINK_DYE)).setFlowerScale(1f);
