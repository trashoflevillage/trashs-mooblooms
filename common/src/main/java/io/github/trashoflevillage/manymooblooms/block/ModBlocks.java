...
public class ModBlocks {
    ...
    public static final RegistrySupplier<Block> BUTTERCUP =
            INITIALIZER.register(
                    ...
                    AbstractBlock.Settings.copy(Blocks.DANDELION), new Item.Settings().arch$tab(ItemGroups.NATURAL)/*.arch$tab(ModItemGroups.BASE_GROUP)*/);
    public static final RegistrySupplier<Block> POTTED_BUTTERCUP =
            INITIALIZER.register(
                    "potted_buttercup", s -> new FlowerPotBlock(BUTTERCUP.get(), s),
                    AbstractBlock.Settings.copy(Blocks.POTTED_DANDELION), null);
